...
import type { BaseFieldProps, HRMFormOption } from 'types';

export type HRMFormDropdownProps = BaseFieldProps & {
...
function HRMFormDropdown({
  ...
  size = 'auto',
  muiFieldProps = {}
}: HRMFormDropdownProps): React.ReactElement {
  const {
    formikField: { field },
  ...
  const renderValue = (value: unknown) => {
    const getValue = (selectedValue: HRMFormOption['value']) => {
    ...
    return getValue(value as HRMFormOption['value']);
  };
...
export default HRMFormDropdown;
