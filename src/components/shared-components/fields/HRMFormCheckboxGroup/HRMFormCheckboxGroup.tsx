...
import HRMFormCheckboxGroupItem from './HRMFormCheckboxGroupItem';
import HRMFormCheckbox from '../HRMFormCheckbox/HRMFormCheckbox';
...
export type HRMFormCheckboxGroupProps = {
...
function HRMFormCheckboxGroup({
  ...
  size = 'auto',
  children
}: HRMFormCheckboxGroupProps): JSX.Element {
  const {
...
export default HRMFormCheckboxGroup;
